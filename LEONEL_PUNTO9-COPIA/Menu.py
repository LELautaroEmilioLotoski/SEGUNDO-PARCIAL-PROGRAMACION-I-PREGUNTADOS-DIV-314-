...
#BOTONES
lista_botones = crear_lista_botones(5,"MENU PYGAME 314/texturas/textura_respuesta.jpg",ANCHO_BOTON,ALTO_BOTON,150,150)


#LISTA AUX
lista_textos_botones = ["JUGAR","AJUSTES","RANKINGS","AGREGAR PREGUNTA","SALIR"]
